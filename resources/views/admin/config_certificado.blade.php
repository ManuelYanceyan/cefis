    ...
    <div class="flex items-center justify-center min-h-[80vh]">
        <div class="w-full max-w-lg bg-white rounded-lg shadow-md p-8 border border-gray-200">
            <div class="mb-6 flex justify-between items-center">
                <h2 class="text-2xl font-bold text-gray-800">Certificado Base General</h2>
            ...
            <form method="POST" action="{{ route('store-config-certificado') }}" enctype="multipart/form-data">
                @csrf
                
                <div class="mb-8">
                    <label for="base" class="block text-gray-700 font-bold mb-4 text-center text-lg">Seleccione el archivo base:</label>
